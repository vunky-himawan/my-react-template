import { CreateOrUpdateRoleSchema, type TCreateOrUpdateRole } from "@/entities/role";
...
export const CreateOrUpdateRoleForm: FC<Props> = ({ children, onSubmit, defaultValues }) => {
  return (
    <DynamicForm
